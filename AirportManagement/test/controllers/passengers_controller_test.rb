...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { aircraft: @passenger.aircraft, checkIn: @passenger.checkIn, destination: @passenger.destination, gate: @passenger.gate, name: @passenger.name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { aircraft: @passenger.aircraft, checkIn: @passenger.checkIn, destination: @passenger.destination, gate: @passenger.gate, name: @passenger.name } }
